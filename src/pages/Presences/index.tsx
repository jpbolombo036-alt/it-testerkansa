...
import { Loader2, Users, Clock, AlertCircle, CheckSquare, LogIn, LogOut, RefreshCw, Calendar } from 'lucide-react'
import { useToast } from '../../components/ToastProvider'
import { fetchTodayDashboard, checkIn, checkOut, AttendanceDashboardDTO, AttendanceReportDTO } from '../../api/attendanceApi'
    ...
    <div className="space-y-6 p-6">
      ...
      {dashboard && (
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={isCheckingIn || (myAttendance?.checkInTime ? true : false)}
          ...
          <div className="rounded-[2.5rem] bg-white p-6 shadow-soft dark:bg-slate-900">
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-4">Présences du jour</h2>
              ...
              <table className="w-full text-left border-separate border-spacing-y-4">
                ...
                <tbody>
                  {dashboard.attendances.length > 0 ? (
                    dashboard.attendances.map((attendance: AttendanceReportDTO) => (
                      <motion.tr
                        key={attendance.id}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
